...
def _gen_diff_list():
    ...
    for language in ['c', 'cpp', 'cc', 'py']:
        diff_list.extend(glob.glob(f"{output_dir}/**/*.{language}.diff", recursive=True))
    print(diff_list)
...
def _gen_rule_info(rule_info_dict):
    body = f"This issue is generated by JARVIS for commit: {GITHUB_SHA}\n"
